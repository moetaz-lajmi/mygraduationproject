          ...
          <div className="relative z-10 flex h-full min-h-0 flex-col">
            ...
            <div className="min-h-0 flex-1 overflow-y-auto overflow-x-hidden px-4 pb-2 pt-2 [scrollbar-gutter:stable]">
              ...
              `}>
                ...
                <button type="button" className="w-full flex items-center justify-center gap-2 bg-white/10 hover:bg-white/15 text-white text-xs font-medium py-2 px-3 rounded-lg transition-all">
